...
(function($) {
  ...
  setTimeout(function() {c2.circleProgress('value', 0.2); }, 1000);
  setTimeout(function() { c2.circleProgress('value', 0.3); }, 5000);
  setTimeout(function() { c2.circleProgress('value', 0.4); }, 9000);
  setTimeout(function() { c2.circleProgress('value', 1); }, 9500);
  ...
  // Let's emulate dynamic value update
   setTimeout(function() {c4.circleProgress('value', 0.2); }, 1000);
  setTimeout(function() { c4.circleProgress('value', 0.5); }, 2000);
  setTimeout(function() { c4.circleProgress('value', 0.6); }, 2900);
  setTimeout(function() { c4.circleProgress('value', 0.7); }, 3500);
  setTimeout(function() { c4.circleProgress('value', 0.8); }, 4000);
    setTimeout(function() { c4.circleProgress('value',1); }, 4500);
