...
class Funnel
{
    ...
    protected function makeProspect()
    {
        ...
        }else if(isset($_POST["r_utm_campaign_id"]) && !empty($_POST["r_utm_campaign_id"]))
        {
                $prospectData["AFID"] = $_POST["r_utm_campaign_id"];
        }

        if(isset($_POST["ad_id"]) && !empty($_POST["ad_id"]))
        {
                $prospectData["SID"] = $_POST["ad_id"];
        }else if(isset($_POST["r_h_ad_id"]) && !empty($_POST["r_h_ad_id"]))
        {
                $prospectData["SID"] = $_POST["r_h_ad_id"];
        }
        ...
        {
            $prospectData["utm_campaign"] = $_POST["r_utm_campaign_id"];
        }
