...
if (url == 'http://localhost') {
    devurl = url + "/creditsecrets/wp-content/root/common/funnel/funnel-v3.php";
    processingUrl = url + "/creditsecrets/wp-content/root/common/funnel/funnel-v3.php";
} else if (url == 'https://creditsecrets.local' || url == 'http://creditsecrets.local' ) {
    devurl = url + "/wp-content/root/common/funnel/funnel-v3.php";
    processingUrl = url + "/wp-content/root/common/funnel/funnel-v3.php";
} else {
    devurl = url + "/common/funnel/funnel-v3.php";
    processingUrl = url + "/common/funnel/funnel-v3.php";
}
...
function addOffer(product){
    ...
    formData.append("info",info);
    formData.append("fname",document.getElementById("fname").value);
    let tags = document.getElementsByClassName("offer_tag");
    for(tag of tags)
    {
