...
class Funnel
{
    ...
    protected function processCheckoutPage()
    {
       ...
       $response = $this->getRequestBody($response);
        ...
        if ($result) {
            ...
            $this->addACTagsIfAny($_POST["email"]);
            sleep(3);
            ...
            if(FreshAddress::isValidEmail($_POST["email"])){
                ...
                $activeCampaign->updateList(55, 54, $_POST["email"]); //unsubscrive from cs vsl partial and subscription to credit secret customers
            }
    ...
    public function addACTagsIfAny($email)
    {
...
if (isset($_POST["ptype"]) && isset($_POST["cId"])) {
    $funnel = new Funnel($_POST["ptype"], $_POST["cId"], $campaign_pages, $tagsMapping2);
    echo json_encode([
