...
if (url == 'http://localhost') {
    devurl = url + "/creditsecrets/wp-content/root/common/funnel/funnel.php";
    processingUrl = url + "/creditsecrets/wp-content/root/common/funnel/funnel.php";
} else if (url == 'https://creditsecrets.local' || url == 'http://creditsecrets.local' ) {
    devurl = url + "/wp-content/root/common/funnel/funnel.php";
    processingUrl = url + "/wp-content/root/common/funnel/funnel.php";
} else {
    devurl = url + "/common/funnel/funnel.php";
    processingUrl = url + "/common/funnel/funnel.php";
}
...
for(form of signupForms){
    form.addEventListener("submit",function(e){
        ...
        if(isValid(getCookie("r_h_ad_id","creditsecrets.com"))){
            formData.append("r_h_ad_id",getCookie("r_h_ad_id","creditsecrets.com"))
        }else if(localStorage.getItem("r_h_ad_id") != null){
            formData.append("r_h_ad_id",localStorage.getItem("r_h_ad_id"));
        }


        if(isValid(getCookie("r_utm_campaign_id","creditsecrets.com")))
        {
            formData.append("r_utm_campaign_id",getCookie("r_utm_campaign_id","creditsecrets.com"))
        }else if(localStorage.getItem("r_utm_campaign_id") != null){
            formData.append("r_utm_campaign_id",localStorage.getItem("r_utm_campaign_id"));
        }
